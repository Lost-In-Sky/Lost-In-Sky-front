  ...
  return (
    <FooterContainer>
      ...
      <ul className="socials">
        <li className="instagram-icon"><a href="https://www.instagram.com/lost._in._sky._hotel/"><InstagramIcon /></a></li>
        ...
        <li><a href="tel:+37491450581" className="phone"><PhoneIcon /> <span>+374 91 45 05 81</span></a></li>
      </ul>
      <Wrapper>
